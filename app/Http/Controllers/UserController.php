...
class UserController extends Controller
{
    ...
    public function result(Request $request)
    {
      ...
      $user_data = DB::table('employee')->select('number','name')->leftJoinSub($subSQL, 'bus', 'employee.number', 'bus.number')->setBindings([':experience_code'=>1, ':experience_class_code'=>7, ':level'=>2])->get();
