...
class UserController extends Controller
{
    ...
    public function result(Request $request)
    {
      ...
      $subSQL = DB::table('business_experience')->where('experience_code', '=', '1')->where('experience_class_code', '=', '7')->where('level', '>', '2')->toSQL();
      $user_data = DB::table('employee')->select('employee.number AS num','employee.name')->leftJoinSub($subSQL, 'bus', 'num', 'bus.number')->get();
